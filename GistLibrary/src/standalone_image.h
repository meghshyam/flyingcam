...
extern image_t *image_new(int width, int height);
...
extern color_image_t *color_image_new(int width, int height);

color_image_t *color_image_cpy(color_image_t *src);

extern void color_image_delete(color_image_t *image);
